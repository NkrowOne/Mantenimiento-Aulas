...
export const ESTADO: Hoja = {
  ...
  columnas: [
    ...
    },
    {
      ...
      nota: 'Sí es una medida de las dos partes: desde la migración 20260830000300 un disparador copia a rooms.projector_hours la lectura de la revisión más reciente, así que el valor de la base está tan vivo como el de la hoja y las fechas se pueden comparar.',
    },
    {
      letra: 'G',
      cabecera: '% Lámparas',

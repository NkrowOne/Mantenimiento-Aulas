...
\echo ''
\echo '=== 41. La bóveda del PIN no se lee ni se escribe desde la API ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');
...
\echo ''
\echo '=== 42. Vincular un dispositivo: el PIN correcto abre, el falso cuenta ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');
...
\echo ''
\echo '=== 43. Cinco intentos fallidos bloquean, y el tope de tres se respeta ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');
...
\echo ''
\echo '=== 44. Revocar es del dueño o del coordinador, y se puede deshacer con otro alta ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');
...
\echo ''
\echo '=== 45. Un código de alta nuevo caduca la bóveda ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');
  select public.guardar_boveda('c2FsLWRlLXBydWViYQ==', 310000, 'BUENO', 'aXY=', 'c29icmU=');
...
\echo ''
\echo '=== 46. El id de un modelo sale de su nombre, aquí y en el cliente ==='
begin;
...
\echo ''
\echo '=== 47. Un técnico propone modelos; validarlos y fusionarlos es del coordinador ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');
...
\echo ''
\echo '=== 48. Fusionar modelos mueve sus equipos y deja lápida ==='
begin;
  select test_as('22222222-2222-4222-8222-222222222222', 'supervisor');
  select public.asset_type_id('Proyector') as tipo \gset
  select id as sala from rooms where active order by created_at limit 1 \gset
...
\echo ''
\echo '=== 49. La fecha de instalación se pone sola y se renueva al cambiar de sala ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');
...
\echo ''
\echo '=== 50. asset_overview identifica el equipo entero, siguiendo las fusiones ==='
begin;
  select test_as('11111111-1111-4111-8111-111111111111', 'tecnico');

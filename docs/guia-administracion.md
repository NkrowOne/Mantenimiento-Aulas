...
| **Cuáles de esas fotos** | Y para este informe y solo para este, debajo de las secciones sale la **rejilla del periodo** con todas marcadas: se toca una para dejarla fuera. Es lo de al lado de «retirar» y no lo mismo: retirar una foto es para siempre y en todos los informes —la persona que se coló—; esto es para el documento que se está pidiendo —la que salió movida, o la que repite lo mismo que la de al lado— y no cambia nada en la ficha del aula. Lo que se quita **se cuenta al pie del documento** —«se dejaron 3 fotos fuera al pedir el informe»—, porque un informe que enseña seis de veinte se leería como si eso fuera todo lo que hubo. Quitar unas hace sitio a las siguientes: el tope de cuarenta se aplica sobre las que quedan. Cambiar el periodo vuelve a marcarlas todas, y no abrir la rejilla es que entren todas |
